...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] relative z-10 animate-in fade-in zoom-in-95 duration-100 border border-slate-200 dark:border-slate-800">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                Digital Civic Infrastructure Ecosystem
              </p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-3 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition text-slate-400"
          >
            <X size={24} />
          </button>
        </div>
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                — это цифровая платформа следующего поколения для улучшения
                социальной инфраструктуры Узбекистана. Мы верим, что современные
                технологии могут сделать взаимодействие гражданина и государства
                мгновенным, прозрачным и эффективным. Наша цель — создать среду,
                где каждый отчет превращается в конкретное действие.
              </p>
            </section>
