...
export const analyticsAPI = {
  getOverview: (): Promise<AxiosResponse> => api.get("/analytics/overview"),
  ...
  getCrops: (
    params?: Pick<AnalyticsParams, "regionCode">
  ): Promise<AxiosResponse> => api.get("/analytics/crops", { params }),
  ...
  getBudget: (
    params?: Pick<AnalyticsParams, "regionCode">
  ): Promise<AxiosResponse> => api.get("/analytics/budget", { params }),

  getChoropleth: (params?: {
    metric?: string;
    regionCode?: number;
  }): Promise<AxiosResponse> => api.get("/analytics/choropleth", { params }),
};
