...
export function formatUZS(value?: number): string | null {
  ...
  if (value >= 1_000_000_000) return `${(value / 1_000_000_000).toFixed(1)} млрд UZS`;
...
export function statusColor(status?: string): string {
  ...
  const map: Record<string, string> = {
    Rejalashtirilgan: 'bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-300',
    Tugallangan: 'bg-green-50 text-green-700 dark:bg-green-950/40 dark:text-green-300',
    "Qurilish/ta'mir": 'bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-300',
    Tender: 'bg-purple-50 text-purple-700 dark:bg-purple-950/40 dark:text-purple-300',
  };
