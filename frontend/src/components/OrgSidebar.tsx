...
export const OrgSidebar: React.FC<OrgSidebarProps> = ({ org, issues, onClose, onIssueClick, onReportIssue }) => {
  ...
  return (
    <div className="absolute top-0 right-0 h-full w-full md:w-[420px] bg-slate-50 dark:bg-slate-950 shadow-2xl z-[500] flex flex-col transform transition-all duration-300 ease-in-out border-l border-slate-200 dark:border-slate-800">
      
      {/* Header */}
      <div className="relative p-6 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
        <button 
          onClick={onClose} 
          className="absolute top-4 right-4 p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition text-slate-400 dark:text-slate-500"
        >
          <X size={20} />
        </button>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-slate-50 dark:bg-slate-800/50 p-2 rounded-xl border border-slate-100 dark:border-slate-800 flex flex-col items-center">
          ...
          <div className="bg-red-50 dark:bg-red-950/20 p-2 rounded-xl border border-red-100 dark:border-red-900/30 flex flex-col items-center">
          ...
          <div className="bg-green-50 dark:bg-green-950/20 p-2 rounded-xl border border-green-100 dark:border-green-900/30 flex flex-col items-center">
          ...
          {orgIssues.length > 0 ? (
            orgIssues.map(issue => (
              <button
                ...
                className="w-full bg-white dark:bg-slate-900 p-3 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-500 transition-all flex items-center gap-3 text-left group shadow-sm"
              >
                <div 
            ...
            <div className="text-center py-12 bg-white dark:bg-slate-900/50 rounded-3xl border border-dashed border-slate-200 dark:border-slate-800">
